                        ...
                        <div class="card-body text-center">
                            <div class="profile-pic mb-20">
                                ...
                                @if (!empty($profile->picture))
                                    <img src="{{ asset('storage/files/' . $profile->picture) }}" width="150"
                        ...
                        @if ($firms != 'No data')
                            <div class="card-body">
                                @foreach ($firms as $firm)
                                    <h6 class="mt-30">Firm/Work Place<br /> 
                                        {{ $firm->name }}
                                    </h6>
                                @endforeach
                        ...
                        <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a style="font-size:17px;" class="nav-link" id="pills-setting-tab" data-toggle="pill"
                                    href="#cv" role="tab" aria-controls="pills-setting"
                                    aria-selected="false">Short
                                    CV</a>
                            </li>
