...
@section('title')
    @parent
    |  Application For Suspend Practising
@stop
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5> Application For Suspend Practising</h5>
                    ...
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">RHC Review</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td id="table_id">
                                                 <div class="table-actions">
                                                    <div class="table-actions">
                                                        <a href="{{ url('permit/suspend/rhc/view', $application->uid) }}"
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td id="table_id">
                                                <div class="table-actions">
                                                    <div class="table-actions">
                                                        <a href="{{ url('permit/resume-practising/rhc/view', $application->uid) }}"
                                                            title="View Profile"><i class="ik ik-eye pull-left"></i></a>
                                                    </div>
                                                </div>
                                            </td>
