...
@section('title')
    @parent
    | Application For Permit Request
@stop
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5>Application For Permit Request</h5>
                                <span>Permit Request Review</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Permit Request Review</li>
                            </ol>
                        </nav>
                    </div>
                </div>
