                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div class="profile-pic mb-20">
                            ...
                            <img src="{{ asset('public/images/files/' . $advocate->profile_detail->picture) }}"
                        ...
                        {{-- <div class="badge badge-pill badge-dark">Admission<br />{{ $petition->admit_as }}
                    </div>
    ...
    <div class="col-lg-8 col-md-7">
        <div class="card">
            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link active" id="pills-timeline-tab" data-toggle="pill"
                        href="#info" role="tab" aria-controls="pills-timeline" aria-selected="true">Personal Info</a>
                </li>

                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link" id="pills-profile-tab" data-toggle="pill"
                        href="#contact" role="tab" aria-controls="pills-profile" aria-selected="false">Contact</a>
                </li>

                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#cv"
                        role="tab" aria-controls="pills-setting" aria-selected="false">Short
                        CV</a>
                </li>

                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#firm"
                        role="tab" aria-controls="pills-setting" aria-selected="false">Firm</a>
                </li>
                ...
                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link" id="pills-setting-tab" data-toggle="pill"
                        href="#education" role="tab" aria-controls="pills-setting" aria-selected="false">Education</a>
                </li>
                <li class="nav-item">
                    <a style="font-size:17px;" class="nav-link" id="pills-setting-tab" data-toggle="pill"
                        href="#experience" role="tab" aria-controls="pills-setting" aria-selected="false">Experience</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="card-body">
                        @if ($educations != 'No data')
                        <div class="col-12">
...
<div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
    <div class="col">
        <div class="p-3 border bg-light"
            style="border-radius:20px; border-color:rgb(243, 76, 76); border-style: solid;">Qualification
            <div>
    ...
    <div class="col">
        <div class="p-3 border bg-light"
            style="border-radius:20px; border-color:rgb(243, 76, 76); border-style: solid;">Admit As

            <a data-toggle="modal" data-target="#addSession" title="Add Session"><i style="color:red; padding-left:5px;"
    ...
    <div class="col">
        <div class="p-3 border bg-light"
            style="border-radius:20px; border-color:rgb(243, 76, 76); border-style: solid;">LST Reg Number
            <div>
                {{$petition->lst_regno}}
            </div>
        </div>
    ...
    <div class="col">
        <div class="p-3 border bg-light"
            style="border-radius:20px; border-color:rgb(243, 76, 76); border-style: solid;">Submission Date

            <div>
                {{$application->submission_at}}
            </div>
        </div>
...
@if ($docus)
<div class="col-12">
    <p class="lead"><i class="ik ik-paperclip"></i> Attachments <a style="color:red;"></a></p>
    <hr />
    <div class="table-responsive">
        <table class="table table-borderless" style="font: size 20px;">
            ...
            <tr>
                ...
                <td>
                    <a style="color:blue;text-decoration:none;" data-toggle="collapse"
                        href="#collapseExample{{$attachments->id}}" role="button" aria-expanded="false"
...
@else
<div class="col-12">
    <p class="lead"><i class="ik ik-paperclip"></i> Attachments <a style="color:red;"
            href="{{ url('petition/attachments') }}"> [ Edit ]</a></p>
    <hr />
    ...
    <div class="col-lg-8 col-md-7" role="document">
        <div class="modal-content">
            <form class="forms-sample" method="POST"
                action="{{ url('petition/cj-appearance/edit', $application->id) }}">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="comment" value="" class="form-control  is-valid"
...
<div class="modal fade" id="addSession" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="forms-sample" method="POST"
                action="{{ url('petition/cj-appearance/admit', $application->id) }}">
                {{ csrf_field() }}
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">Admit As</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Select Your Decision</label>
                                <select class="form-control selectpicker" name="admit_as" required
