                                                ...
                                                @foreach ($personal_infos as $personal_info)
                                                    <table class="table table-borderless" style="font: size 20px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ date('F d, Y', strtotime($personal_info->dob)) }}</td>
                                                ...
                                                @foreach ($applications as $key => $application)
                                                    <table class="table table-borderless" style="font: size 20px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ date('F d, Y', strtotime($application->submission_at)) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width:20%;text-align:right;">Status:</th>
                ...
                <div class="col-lg-8 col-md-7" role="document">
                    <div class="modal-content">
                        <form class="forms-sample" method="POST"
                            action="{{ url('petition/legal-objections/edit', $petition->id) }}">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Add Comment To Petitioner</label>
                                         <textarea name="comment" class="form-control is-valid" placeholder="Comment" required 
                                         style="padding: 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px;"></textarea>
                                        </div>
                                    </div>
                                </div>
