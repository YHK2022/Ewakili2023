...
@section('title')
    @parent
    | Postponed Petition Applications
@stop
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5>Postponed Petition Applicationss</h5>
                                <span>Postponed Review</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Postponed Review</li>
                            </ol>
                        </nav>
                    </div>
                </div>
