...
@section('title')
    @parent
    | Deferred Petition Applications
@stop
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5>Deferred Petition Applications</h5>
                                <span>Deferred Review</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Deferred Review</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td id="table_id">
                                                <div class="table-actions">
                                                    <div class="table-actions">
                                                        <a href="{{ url('petition/cle/view', $application->uid) }}"
