...
<body>
   ...
   {{-- <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> --}}
    ...
    $(document).ready(function() {
        // Add click event handling for each link
        @foreach($coram_lists as $coram_list)
            $('#coram-link-{{ $coram_list->id }}').click(function(e) {
                e.preventDefault();

                // Load the related_data view
                $('#related-data-container').load('{{ route('coram_cle_members', $coram_list->id) }}');
            });
        @endforeach
    });
    ...
    $(document).ready(function() {
        // Add click event handling for each link
        @foreach($appearance_lists as $coram_list)
            $('#coram-link-{{ $coram_list->id }}').click(function(e) {
                e.preventDefault();

                // Load the related_data view
                $('#appearance-data-container').load('{{ route('appearance_members', $coram_list->id) }}');
            });
        @endforeach
    });
