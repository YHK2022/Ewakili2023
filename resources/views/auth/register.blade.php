            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto" >
                            <h3><center>National ID verification</center></h3>
                            ...
                            <form method="POST" action="{{ url('advocate-post-register')}}" >
							{{ csrf_field() }}

                              <div class="form-group">
                                <input type="text" name="national_id" value="{{ old('national_id') }}" class="form-control is-valid" placeholder="National ID" required>
                                        <i class="ik ik-credit-card"></i>
                              </div>

                                <div class="sign-btn text-center">
                                    <button class="btn btn-theme" data-loading-text="Submiting request.....">Check National ID</button>
                                </div>
                            </form>
                            <div class="register">
