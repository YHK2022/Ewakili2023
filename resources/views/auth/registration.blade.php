...
<html class="no-js" lang="en">
    ...
    <div class="form-group">
        <input type="text" name="national_id" value="{{ old('national_id') }}" class="form-control is-valid" placeholder="National ID" id="exampleInputNationalId">
    ...
    <div class="form-group">
        <input type="text" name="email" value="{{ old('email') }}" class="form-control is-valid" placeholder="Valid Email eg. email@example.com" id="exampleInputUsername">
    ...
    <div class="sign-btn text-center">
        @if (isset($nationalIdData) && !empty($nationalIdData))
        <!-- National ID exists, show password input -->
        <div class="form-group">
            <input type="password" name="national_id_password" class="form-control is-valid" placeholder="National ID Password" id="exampleInputPassword">
            <i class="ik ik-lock"></i>
        </div>
        @endif

        <button class="btn btn-theme" data-loading-text="Submitting request...">Apply</button>
    </div>
</form>
