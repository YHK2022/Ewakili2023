        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ url('temporary/update-profiles',$profile->id)}}">
                        {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <a href="{{ url('temporary/application-form') }}" class="btn btn-primary">Next</a>
                        </form>
                    </div>
            ...
            <div class="card">
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ url('temporary/post-profiles')}}">
                        {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
